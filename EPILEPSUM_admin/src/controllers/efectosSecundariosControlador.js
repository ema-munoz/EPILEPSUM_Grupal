...
efectosSecundariosCtl.lista = async (req, res) => {
    ...
    res.render('efectosSecundarios/efectosSecundariosListas', {
        lista
    })
}
...
efectosSecundariosCtl.traer = async (req, res) => {
    ...
    res.render('efectosSecundarios/efectosSecundariosEditar', {
        lista
    })
...
efectosSecundariosCtl.actualizar = async (req, res) => {
    ...
    await baseDatosORM.efectosSecundarios.findOne({
            where: {
                idEfectosSecundarios: ids
            }
        })
        .then(actualizar => {
...
efectosSecundariosCtl.eliminar = async (req, res) => {
    ...
    await baseDatosORM.efectosSecundarios.destroy({
        where: {
            idEfectosSecundarios: id
        }
    })
